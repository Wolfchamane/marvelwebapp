export namespace CharactersTypes {
    export type CharacterRace = 'Saiyan' | 'Namekian' | 'Human'|'Majin'|'Frieza Race'|'Jiren Race'|'Android'|'God'|'Angel'|'Evil'|'Unknown'|'Nucleico benigno'|'Nucleico';
    export type CharacterGender = 'Male' | 'Female' | 'Other' | 'Unknown';
    export type CharacterAffiliation = 'Z Fighter' | 'Red Ribbon Army' | 'Namekian Warrior' | 'Freelancer' | 'Army of Frieza' | 'Other' | 'Pride Troopers' | 'Assistant of Vermoud' | 'Assistant of Beerus' | 'Villain';
